...
-(void)jobReadRequestOldRegion:(MKCoordinateRegion)oldRegion newRegion:(MKCoordinateRegion)newRegion field:(NSString*)field kind:(NSString *)kind
{
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url];
    NSString *postFormatString = @"oldLatitude=%f&oldLongitude=%f&oldLatSpan=%f&oldLongSpan=%f&newLatitude=%f&newLongitude=%f&newLatSpan=%f&newLongSpan=%f&field=%@&kind=%@";
    NSString *postString = [NSString stringWithFormat:postFormatString,
                            oldRegion.center.latitude,oldRegion.center.longitude,oldRegion.span.latitudeDelta,oldRegion.span.longitudeDelta,
                                newRegion.center.latitude,newRegion.center.longitude,newRegion.span.latitudeDelta,newRegion.span.longitudeDelta,field,kind];
...
-(void)jobReadRequest:(MKCoordinateRegion)region field:(NSString*)field kind:(NSString *)kind
{
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url];
    NSString *postFormatString = @"latitude=%f&longitude=%f&latSpan=%f&longSpan=%f&field=%@&kind=%@";
    NSString *postString = [NSString stringWithFormat:postFormatString,
                            region.center.latitude,region.center.longitude,region.span.latitudeDelta,region.span.longitudeDelta,field,kind];
